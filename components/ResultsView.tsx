...
const ResultsView: React.FC<ResultsViewProps> = ({ data, onReset, locationName, capturedImage }) => {
      ...
      <div className="mb-6">
        {!videoUri ? (
          <button
            ...
            className={`w-full py-4 rounded-xl font-bold shadow-lg flex items-center justify-center gap-2 transition-all ${isGeneratingVideo
          ...
          >
            {isGeneratingVideo ? (
              <>
                <Loader2 className="animate-spin" /> Generating Photorealistic Video...
              </>
            ) : (
              <>
